function [data_TrialEvent, early_lick, trial_note_type] = Ingest_EXP_TrialEvent (obj, key, iTrials, data_TrialEvent, action_event_time)
...
% early lick: aftter presample onset and before the go cue
early_lick_flag_presample_onwards = sum(action_event_time >= presample_t & action_event_time <= go_t); %if the flag has other elements than 0 - it means that there was an ealy licka
