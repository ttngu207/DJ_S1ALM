...
classdef UnitTongue1DTuningSignificanceLRseparate < dj.Computed
    properties
        keySource = ANL.UnitTongue1DTuningLRseparateShuffling;
    end
    methods(Access=protected)
        function makeTuples(self, key)
            
            tongue_tuning_1d_si_shuffled= fetch1(ANL.UnitTongue1DTuningLRseparateShuffling & key,'tongue_tuning_1d_si_shuffled');
            tongue_tuning_1d_si_shuffled_mean= fetch1(ANL.UnitTongue1DTuningLRseparateShuffling & key,'tongue_tuning_1d_si_shuffled_mean');
            tongue_tuning_1d_si= fetch1(ANL.UnitTongue1DTuningLRseparate & key,'tongue_tuning_1d_si');
