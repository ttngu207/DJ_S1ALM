...
classdef ProjTrialAverageLR2 < dj.Computed
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            if contains(k.unit_quality,'ok or good')
                ...
                Modes = fetch ( (ANL.Mode2* EPHYS.Unit * EPHYS.UnitCellType * EPHYS.UnitPosition)  & ANL.IncludeUnit & k & 'unit_quality="ok" or unit_quality="good"', '*');
                ...
                Modes = fetch (ANL.Mode2*EPHYS.UnitCellType * EPHYS.UnitPosition & ANL.IncludeUnit & k, '*');
