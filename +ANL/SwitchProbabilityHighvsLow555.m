...
classdef SwitchProbabilityHighvsLow555 < dj.Computed
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            key.time_used_for_decoding_start=-1.8;
            ...
            rel_Proj = ( ANL.ProjTrial333 * EXP.Session * EXP.SessionID  * ANL.SVMdecoderFindErrorTrials ) & key & 'outcome!="ignore"' & (EXP.BehaviorTrial & 'early_lick="no early"') & sprintf('num_units_projected>=%d', min_num_units_projected); %note that if ANL.ProjTrial22 also has outcome "response" it should be exluded too
