...
classdef IncludeUnit4 < dj.Computed
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            minimal_mean_fr = 0.25%;Param.parameter_value{(strcmp('minimal_mean_fr',Param.parameter_name))};
...
%                         minimal_adaptive_peak_fr_basic_trials = Param.parameter_value{(strcmp('minimal_adaptive_peak_fr_basic_trials',Param.parameter_name))};
            ...
            if (trials_r>= mintrials_unit &&  trials_l>= mintrials_unit) && ...
                    (FR.mean_fr_sample_delay >= minimal_mean_fr)
                insert(self,key);
            end
