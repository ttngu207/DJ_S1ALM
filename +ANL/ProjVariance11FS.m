...
classdef ProjVariance11FS < dj.Computed
    properties
        ...
        function makeTuples(self, key)
            ...
            if contains(key.outcome,'response')
                ...
                if contains(k.unit_quality, 'ok or good')
                    rel_Proj =(ANL.ProjTrialDA11FS*EXP.BehaviorTrial * ANL.TrialTypeGraphic) & k & 'outcome!="ignore"' & 'early_lick="no early"';
                ...
                elseif contains(k.unit_quality, 'all')
                    rel_Proj =( ANL.ProjTrialDA11FS * ANL.TrialTypeGraphic*EXP.BehaviorTrial) & k & 'outcome!="ignore"' & 'early_lick="no early"';
                    k = rmfield(k,'unit_quality');
            ...
            elseif contains(key.outcome,'hit')
                if contains(k.unit_quality, 'ok or good')
                    rel_Proj =(ANL.ProjTrialDA11FS*EXP.BehaviorTrial * ANL.TrialTypeGraphic) & k  & 'early_lick="no early"';
                    k = rmfield(k,'unit_quality');
                ...
                elseif contains(k.unit_quality, 'all')
                    rel_Proj =( ANL.ProjTrialDA11FS * ANL.TrialTypeGraphic*EXP.BehaviorTrial) & k &  'early_lick="no early"';
                    k = rmfield(k,'unit_quality');
