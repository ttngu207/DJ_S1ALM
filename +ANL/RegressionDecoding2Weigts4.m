...
classdef RegressionDecoding2Weigts4 < dj.Computed
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            rel_behav= EXP.TrialID & ((EXP.BehaviorTrial * EXP.TrialName  * ANL.TrialTypeGraphic* ANL.Video1stLickTrialZscoreAllLR )   & k  & 'early_lick="no early"')& ANL.RegressionProjTrial2Weights4;
            ...
            rel_Proj = ((ANL.RegressionProjTrial2Weights4	 & rel_behav) &k_proj  )*EXP.TrialID*EXP.TrialName*EXP.BehaviorTrial;
