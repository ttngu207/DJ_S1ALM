...
classdef SVMdecoderSensoryMotorLR < dj.Computed
    properties
        keySource = (EXP.Session & EPHYS.TrialSpikes) * (ANL.LickDirectionType & 'lick_direction!="all"')
    end
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            [t,perf_t,smallest_set_num] = fn_SVM_performance_sensory_motor_direction(key);
