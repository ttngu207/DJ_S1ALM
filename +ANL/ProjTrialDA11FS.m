...
classdef ProjTrialDA11FS < dj.Computed
    properties
        
        keySource = (EXP.Session  & EPHYS.Unit) * (EPHYS.CellType & 'cell_type="FS"') * (EPHYS.UnitQualityType & 'unit_quality="all"') * (EXP.Outcome & 'outcome="hit" or outcome="miss"') * (ANL.ModeTypeName & ANL.Mode11FS) * (ANL.ModeWeightsSign & 'mode_weights_sign="all"');
