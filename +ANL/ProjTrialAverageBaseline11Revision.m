...
classdef ProjTrialAverageBaseline11Revision < dj.Computed
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            k=key;
            Modes = fetch (ANL.Mode11Revision  & k, '*');
            ...
            if ~isempty(mode_names)
                ...
                Proj =  fetch(ANL.ProjTrialAverage11Revision & key,'*');
...
%                 l_proj = fetch1(ANL.ProjTrialAdaptiveAverage & key & kkl,'proj_average');
                l_proj = fetch1(ANL.ProjTrialAverage11Revision & key & kkl,'proj_average');
