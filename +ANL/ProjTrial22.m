...
classdef ProjTrial22 < dj.Computed
    properties
        
        keySource = (EXP.Session  & EPHYS.Unit) * (EPHYS.CellType & 'cell_type="Pyr"') * (EPHYS.UnitQualityType & 'unit_quality="all"') * EXP.Outcome * (ANL.ModeTypeName & 'mode_type_name="Ramping Orthog.1"') * (ANL.ModeWeightsSign & 'mode_weights_sign="all"');
