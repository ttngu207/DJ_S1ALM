...
classdef RegressionDecodingbetaXR2Time < dj.Computed
    properties
        
        keySource = ((EXP.Session  & EPHYS.Unit & ANL.Video1stLickTrialZscore) *ANL.LickDirectionType *  ANL.FlagBasicTrialsDecoding* ANL.OutcomeTypeDecoding* (ANL.TongueTuning1DType & 'tuning_param_name="lick_horizoffset_relative" or tuning_param_name="lick_rt_video_onset" or tuning_param_name="lick_peak_x"') & ANL.IncludeSession -ANL.ExcludeSession)*ANL.RegressionTime4;
    end
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            rel_behav= EXP.TrialID & ((EXP.BehaviorTrial * EXP.TrialName  * ANL.TrialTypeGraphic* ANL.Video1stLickTrialZscoreAllLR )   & k  & 'early_lick="no early"')& ANL.RegressionProjTrialNormalizedSignif3;
            ...
            rel_Proj = ((ANL.RegressionProjTrialNormalizedbetaXR2	 & rel_behav) &k_proj  )*EXP.TrialID*EXP.TrialName*EXP.BehaviorTrial;
