...
classdef ProjTrialAdaptiveAverageBaseline2 < dj.Computed
    properties
        ...
        function makeTuples(self, key)
            ...
            if ~isempty(mode_names)
                for imod = 1:1:numel(mode_names)
                    ...
                    Proj =  fetch(ANL.ProjTrialAdaptiveAverage2 & key,'*');
                     if numel(Proj)==0
                         return
                     end
                    kkl.trial_type_name='l';
                    l_proj = fetch1(ANL.ProjTrialAdaptiveAverage2 & key & kkl,'proj_average');
