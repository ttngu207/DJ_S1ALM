...
classdef ProjTrialAverage11FS < dj.Computed
    properties
                 keySource = (EXP.Session  & EPHYS.Unit) * (EPHYS.CellType & 'cell_type="FS"') * (EPHYS.UnitQualityType & 'unit_quality="all" or unit_quality="ok or good"') * EXP.Outcome * (ANL.ModeWeightsSign) * (ANL.ModeTypeName & ANL.Mode11FS );
