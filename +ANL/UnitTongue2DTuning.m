...
classdef UnitTongue2DTuning < dj.Computed
    properties
        keySource = ((EPHYS.Unit & 'unit_quality!="multi"' & (EPHYS.UnitCellType & 'cell_type="PYR" or cell_type="FS"')) & ANL.Video1stLickTrialNormalized) * (ANL.TongueTuningXType & 'tuning_param_name_x="lick_yaw_relative"') * (ANL.TongueTuningYType & 'tuning_param_name_y="lick_peak_x"') * (ANL.OutcomeType & 'outcome="all"') * ANL.TongueTuningSmoothFlag;
    end
