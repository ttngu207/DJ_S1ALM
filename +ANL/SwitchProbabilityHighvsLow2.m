...
classdef SwitchProbabilityHighvsLow2 < dj.Computed
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            key.time_used_for_decoding_start=-2.1;
            ...
            rel_Proj = ( ANL.ProjTrial22 * EXP.Session * EXP.SessionID  * ANL.SVMdecoderFindErrorTrials ) & key & 'outcome!="ignore"' & (EXP.BehaviorTrial & 'early_lick="no early"');
            ...
            for i=1:1:numel(trial_decoded_type)
                ...
                p = fn_compute_proj_binning_high_vs_low2 (proj(i),proj(1), tidx, time);
