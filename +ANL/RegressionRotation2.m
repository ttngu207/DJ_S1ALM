...
classdef RegressionRotation2 < dj.Computed
    properties
    ...
    methods(Access=protected)
        ...
        function makeTuples(self, key)
            ...
            dir_save_figure = [dir_root 'Results\video_tracking\analysis\regression_rotation2\' key.tuning_param_name	'\' key.lick_direction '\'];
