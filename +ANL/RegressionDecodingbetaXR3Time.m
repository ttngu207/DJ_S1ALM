...
classdef RegressionDecodingbetaXR3Time < dj.Computed
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            rel_Proj = ((ANL.RegressionProjTrialNormalizedbetaXR3	 & rel_behav) &k_proj  )*EXP.TrialID*EXP.TrialName*EXP.BehaviorTrial;
