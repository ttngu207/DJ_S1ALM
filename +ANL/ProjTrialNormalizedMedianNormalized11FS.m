...
classdef ProjTrialNormalizedMedianNormalized11FS < dj.Computed
    properties
        ...
        keySource = (EXP.Session  & EPHYS.Unit) * (EPHYS.CellType & 'cell_type="FS"') * (EPHYS.UnitQualityType & 'unit_quality="all"')   * (ANL.ModeWeightsSign & 'mode_weights_sign="all"') *  (ANL.ModeTypeName & 'mode_type_name="ChoiceMatched" or mode_type_name="Ramping Orthog.111"');
