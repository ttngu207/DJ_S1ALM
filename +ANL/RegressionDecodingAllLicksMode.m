...
classdef RegressionDecodingAllLicksMode < dj.Computed
    properties
        
        keySource = ((EXP.Session  & EPHYS.Unit & ANL.VideoNthLickTrial) *ANL.LickDirectionType *  (ANL.FlagBasicTrialsDecoding & 'flag_use_basic_trials_decoding=0') * (ANL.OutcomeTypeDecoding & 'outcome_trials_for_decoding="all"')* (ANL.TongueTuning1DType & 'tuning_param_name="lick_horizoffset" or tuning_param_name="lick_rt_video_onset" or tuning_param_name="lick_peak_x"') );
    end
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            fn_regression_decoding_all_licks_mode (key,self, rel_all_lick)
