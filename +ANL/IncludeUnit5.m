...
classdef IncludeUnit5 < dj.Computed
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            mintrials_unit =  10;%;Param.parameter_value{(strcmp('mintrials_unit',Param.parameter_name))};
            minimal_mean_fr = 0;Param.parameter_value{(strcmp('minimal_mean_fr',Param.parameter_name))};
...
%                         minimal_adaptive_peak_fr_basic_trials = Param.parameter_value{(strcmp('minimal_adaptive_peak_fr_basic_trials',Param.parameter_name))};
            ...
            if (trials_r>= mintrials_unit &&  trials_l>= mintrials_unit) && ...
                    ((FR.mean_fr_sample >= minimal_mean_fr) || (FR.mean_fr_delay >= minimal_mean_fr))
                insert(self,key);
            end
