...
classdef SwitchProbabilityHighvsLow3 < dj.Computed
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            rel_Proj = ( ANL.ProjTrial11 * EXP.Session * EXP.SessionID  * ANL.SVMdecoderFindErrorTrials ) & key & 'outcome!="ignore"' & (EXP.BehaviorTrial & 'early_lick="no early"');
