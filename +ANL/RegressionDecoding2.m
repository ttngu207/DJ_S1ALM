...
classdef RegressionDecoding2 < dj.Computed
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            rel_behav= EXP.TrialID & ((EXP.BehaviorTrial * EXP.TrialName  * ANL.TrialTypeGraphic* ANL.Video1stLickTrial *ANL.LickDirectionTrial)   & k  & 'early_lick="no early"' ) & ANL.RegressionProjTrialGo2 & ANL.VideoTongueValidRTTrial ;
            ...
            rel_Proj = ((ANL.RegressionProjTrialGo2	 & rel_behav) &k_proj  )*EXP.TrialID*EXP.TrialName*EXP.BehaviorTrial;
