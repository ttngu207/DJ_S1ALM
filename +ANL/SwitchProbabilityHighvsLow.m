    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            for i=1:1:numel(trial_decoded_type)
                ...
                p = fn_compute_proj_binning_high_vs_low (proj(i),proj(1), tidx, time);
