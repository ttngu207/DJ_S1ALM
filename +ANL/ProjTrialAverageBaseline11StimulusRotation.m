...
classdef ProjTrialAverageBaseline11StimulusRotation < dj.Computed
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            k=key;
            Modes = fetch (ANL.ModeStimulusRotation  & k, '*');
            ...
            if ~isempty(mode_names)
                ...
                Proj =  fetch(ANL.ProjTrialAverage11StimulusRotation & key,'*');
...
%                 l_proj = fetch1(ANL.ProjTrialAdaptiveAverage & key & kkl,'proj_average');
                l_proj = fetch1(ANL.ProjTrialAverage11StimulusRotation & key & kkl,'proj_average');
