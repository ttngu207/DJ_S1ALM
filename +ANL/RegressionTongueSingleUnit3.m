...
classdef RegressionTongueSingleUnit3 < dj.Computed
    properties
...
%                 keySource = ((EPHYS.Unit & 'unit_quality!="multi"' & (EPHYS.UnitCellType & 'cell_type="PYR" or cell_type="FS"')) & ANL.Video1stLickTrial)  * (ANL.OutcomeType & 'outcome_grouping="all"') * (ANL.FlagBasicTrials & 'flag_use_basic_trials=0')  * (ANL.TongueTuning1DType & 'tuning_param_name="lick_peak_x"') * ANL.RegressionTime2 * ANL.LickDirectionType;
