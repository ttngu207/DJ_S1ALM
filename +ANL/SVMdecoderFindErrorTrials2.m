...
classdef SVMdecoderFindErrorTrials2 < dj.Computed
    properties
        keySource = (EXP.Session & EPHYS.Unit) * (EXP.TrialNameType & 'trial_type_name="l" or trial_type_name="l_-0.8Full"') & (EXP.SessionTraining & 'training_type="distractor"');
