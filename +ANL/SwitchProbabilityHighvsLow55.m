...
classdef SwitchProbabilityHighvsLow55 < dj.Computed
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            rel_Proj = ( ANL.ProjTrial222 * EXP.Session * EXP.SessionID  * ANL.SVMdecoderFindErrorTrials ) & key & 'outcome!="ignore"' & (EXP.BehaviorTrial & 'early_lick="no early"') & sprintf('num_units_projected>=%d', min_num_units_projected); %note that if ANL.ProjTrial22 also has outcome "response" it should be exluded too
