...
classdef RegressionDecodingNthLick3 < dj.Computed
    properties
...
%             k.regression_time_start=round(0,4);
            ...
            rel_behav= EXP.TrialID & ((EXP.BehaviorTrial * EXP.TrialName  * ANL.TrialTypeGraphic* ANL.VideoNthLickTrial)   & k  & 'early_lick="no early"' ) & ANL.RegressionProjTrialGo3 & ANL.VideoTongueValidRTTrial ;
...
%                 temp_rel_lick.count
                ...
                fn_regression_decoding_lick_number3 (key,self, rel_Nth_lick)
            end
        end
    end
end