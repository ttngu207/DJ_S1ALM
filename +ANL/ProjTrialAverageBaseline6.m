...
classdef ProjTrialAverageBaseline6 < dj.Computed
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            if ~isempty(mode_names)
                ...
                Proj =  fetch(ANL.ProjTrialAverage6 & key,'*');
...
%                 l_proj = fetch1(ANL.ProjTrialAdaptiveAverage & key & kkl,'proj_average');
                l_proj = fetch1(ANL.ProjTrialAverage6 & key & kkl,'proj_average');
