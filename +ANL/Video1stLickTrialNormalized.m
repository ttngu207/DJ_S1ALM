...
classdef Video1stLickTrialNormalized < dj.Computed
    ...
    methods(Access=protected)
        ...
        function makeTuples(self, key)
            ...
            k=key;
            k=rmfield(k,'trial');
            T_all=fetch(ANL.Video1stLickTrial & k,'*');
