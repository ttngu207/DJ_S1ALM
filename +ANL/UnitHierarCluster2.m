...
classdef UnitHierarCluster2 < dj.Computed
    properties
%         keySource = ((EPHYS.CellType &  (ANL.IncludeSession- ANL.ExcludeSession)) & 'cell_type="Pyr" or cell_type="all" or cell_type="FS"') * (EPHYS.UnitQualityType & 'unit_quality="ok or good" or unit_quality="good" or unit_quality="all"') * (LAB.BrainArea & 'brain_area="ALM"') * LAB.Hemisphere * EXP.TrainingType ;
        
        keySource = ((EPHYS.CellType &  (ANL.IncludeSession- ANL.ExcludeSession)) & 'cell_type="Pyr" or cell_type="all" or cell_type="FS"') * (EPHYS.UnitQualityType & 'unit_quality="ok or good" or unit_quality="good" or unit_quality="all"') * (LAB.BrainArea & 'brain_area="vS1"') * (LAB.Hemisphere & 'hemisphere="left"') * EXP.TrainingType ;
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            key.heirar_cluster_time_end = 1.5;
