...
classdef RegressionRotation < dj.Computed
    ...
    methods(Access=protected)
        ...
        function makeTuples(self, key)
            ...
            dir_save_figure = [dir_root 'Results\video_tracking\analysis\regression_rotation\' key.tuning_param_name	'\' key.lick_direction '\'];
            ...
            rel=ANL.RegressionTongueSingleUnit*EPHYS.UnitCellType & kk;
            ...
            regression_weight=regression_coeff_b2.*regression_rsq;
            regression_weight2=regression_coeff_b2.*regression_p;
