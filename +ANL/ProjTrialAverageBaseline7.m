...
classdef ProjTrialAverageBaseline7 < dj.Computed
    properties
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            if ~isempty(mode_names)
                ...
                Proj =  fetch(ANL.ProjTrialAverage7 & key,'*');
...
%                 l_proj = fetch1(ANL.ProjTrialAdaptiveAverage & key & kkl,'proj_average');
                l_proj = fetch1(ANL.ProjTrialAverage7 & key & kkl,'proj_average');
