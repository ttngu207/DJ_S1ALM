...
classdef Mode888 < dj.Computed
    ...
    methods(Access=protected)
        function makeTuples(self, key)
            ...
            unit_num=fetchn(((EPHYS.Unit & ANL.IncludeUnit5) * EPHYS.UnitCellType) & key, 'unit', 'ORDER BY unit_uid');
            electrode_group=fetchn(((EPHYS.Unit & ANL.IncludeUnit5) * EPHYS.UnitCellType) & key, 'electrode_group', 'ORDER BY unit_uid');
