function  [key] = fn_projectTrialWeights4(M, PSTH, key)
...
for itr= 1:1:numel(trials)
    ...
    regression_p=-log10([Mtrial.regression_p]+eps);
    weights = ([Mtrial.regression_coeff_b2_normalized].*[Mtrial.regression_rsq])';
