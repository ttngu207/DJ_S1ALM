function fn_regression_decoding_lick_number3 (key,self, rel_Nth_lick)
...
rel_Proj = ((ANL.RegressionProjTrialGo3	 & rel_Nth_lick) &k_proj  )*EXP.TrialID*EXP.TrialName*EXP.BehaviorTrial;
...
for i_t=1:1:numel(t)
    ...
    X=(P.endpoint)';
    [X,Y,Linear] = fn_compute_linear_regression2 (X,Y);
