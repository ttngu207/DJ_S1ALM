function weights = computeModeWeights_correct_and_error_matched_lefttrials(psth_t_u_tr, trials_R_correct, trials_L_correct,trials_R_error, trials_L_error, tint1, tint2, psth_t_vector, mintrials_modeweights,smallest_set_num)


    
    
    
    trials1=  [datasample(trials_L_error,smallest_set_num,'Replace',false)];
    trials2=  [datasample(trials_L_correct,smallest_set_num,'Replace',false)];
