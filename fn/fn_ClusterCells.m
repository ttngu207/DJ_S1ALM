function [cl_id]=fn_ClusterCells(PTSH_RLconcat, time, key)
...
if (contains(key.brain_area,'vS1') || contains(key.cell_type,'FS'))
    n_clust =15; %20 for FS %50 for PYR; for vS1 20 for both cell types
else
    n_clust =50; %20 for FS %50 for PYR; for vS1 20 for both cell types
end
