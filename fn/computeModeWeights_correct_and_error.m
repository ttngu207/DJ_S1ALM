function weights = computeModeWeights_correct_and_error(psth_t_u_tr, trials_R_correct, trials_L_correct,trials_R_error, trials_L_error, tint1, tint2, psth_t_vector, mintrials_modeweights)

trials1=[trials_R_correct;trials_L_error];
trials2=[trials_L_correct;trials_R_error];
