function  [key, counter] = fn_projectSingleTrial_populateNormalized22(M, PSTH, key, counter, Param)
...
mode_time1_st =  unique(fetchn(ANL.Mode55 & k_mode,'mode_time1_st'));
mode_time1_end =  unique(fetchn(ANL.Mode55 & k_mode,'mode_time1_end'));
