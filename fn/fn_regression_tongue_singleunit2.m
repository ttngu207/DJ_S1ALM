function fn_regression_tongue_singleunit2 (Y, SPIKES, key,kk, time_window_duration, t_vec, num_repeat, fraction_train, self)
...
%             Y=rescale(Y);
            ...
            for i_twnd=1:numel(t_wnd)
                ...
                [beta,Rsq, regression_p,beta_normalized]= fn_regression_parameters2 (FR_TRIAL,Y, num_repeat, fraction_train);
